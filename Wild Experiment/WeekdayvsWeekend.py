...
def get_time(latitude, longitude, time):
	...
	try:
		...
		day_of_the_week = adjusted_date_time.weekday()
...
if __name__ == "__main__":
	...
	# visited_hexagons = pd.read_csv("./Data/No_HomeV2/Hexagons_Visited_10MinDuration.csv")	
	...
	out_file = open("./Data/No_HomeV3/Weekday_Hexagon_Bucket_Percentages_Visited_5MinResolution_No_YASIR_UAE.json", "w")
	...
	output.to_csv("./Data/No_HomeV3/Weekday_Hexagon_Bucket_Percentages_Visited_5MinResolution_No_YASIR_UAE.csv")
